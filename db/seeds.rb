...
# The data can then be loaded with the bin/rails db:seed command (or created alongsid_from_atelier_from_ateliere the database with db:setup).
#
# Examples:
#
